          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="px-2 py-0.5 bg-[#FFF8FA] text-gray-600 text-xs font-medium rounded-full">
                  +2 more
                </span>
              </div>
              <a
            ...
            <ResponsiveContainer width="100%" height={400}>
              <AreaChart data={revenueData}>
                ...
                <Area
                  ...
                  dot={{ fill: "#0072CE", r: 4 }}
                  activeDot={{ r: 6, fill: "#0072CE" }}
                />
              </AreaChart>
            </ResponsiveContainer>

            {/* Pipeline Stage Summary and Activation Tasks Section */}
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <a href="#" className="text-xs text-gray-500 hover:text-gray-700 font-medium">
                  View all <HiArrowRight className="w-3 h-3 inline ml-1" />
                </a>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                  ...
                  <p className="text-xs text-gray-600 mb-2">
                    You added a new lead - <span className="font-semibold">BlueTech Ltd</span>
                  </p>
